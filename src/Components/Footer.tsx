    ...
    <footer className="footer bg-base-300 text-base-content footer-center p-5 rounded-xl">
      <div>
        ...
        <div title="Github ↗︎" className="items-center flex-none">
          <a aria-label="Github" target="_blank" href="https://github.com/guillaume-gomez/tile-and-square" rel="noreferrer" className="normal-case btn btn-primary drawer-button btn-square">
