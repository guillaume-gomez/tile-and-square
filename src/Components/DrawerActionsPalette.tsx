...
function DrawerActionsPalette({ canvasRef, pencilThickness, eraserThickness, onChangePencilThickness, onChangeEraserThickness } : DrawerActionsPaletteInterface) {
  ...
  return (
      <div className="w-full h-full flex flex-col justify-between">
        <div className="grid grid-cols-2 gap-2">
          <div className={`btn btn-outline ${typeOfDrawing === "pencil" ? "btn-active" : "" } `} onClick={usePencil}>
          ...
          <div className={`btn btn-outline ${typeOfDrawing === "eraser" ? "btn-active" : "" } `} onClick={useEraser}>
        ...
        <SliderWithLabel label="Pencil tickness" value={pencilThickness} onChange={(value) =>onChangePencilThickness(parseInt(value))}/>
        <SliderWithLabel label="Eraser thickness" value={eraserThickness} onChange={(value) => onChangeEraserThickness(parseInt(value))}/>
        
        <div className="btn btn-outline" onClick={save}>
            Save
          </div>
       </div>
  );
